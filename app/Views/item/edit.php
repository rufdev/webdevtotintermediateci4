...
<form action="<?=base_url()?>item/edit/<?=$item->id?>" method="post" >
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="id" name="id" readonly value="<?=set_value('id', $item->id)?>" type="text" class="form-control">
    </div>
  </div>
  <div class="form-group row">
    <label for="name" class="col-4 col-form-label">Name</label> 
    <div class="col-8">
      <input id="name" name="name" value="<?=set_value('name', $item->name)?>" placeholder="Enter Item Name" type="text" class="form-control">
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="price" name="price" value="<?=set_value('price', $item->price)?>" placeholder="0" type="text" class="form-control">
      </div>
    </div>
  </div>
  <div class="form-group row">
